<template>
	...
	<section class="container-fluid d-flex flex-column align-items-center py-5 px-1">
		<div class="container row px-0 px-md-2 px-xxl-5 py-5">
			<div class="category-links d-flex flex-column flex-sm-row gap-3 ms-sm-4 mb-3 p-0">
				<base-button :class="setActiveLink('all')" @click="category = 'all'"
					>All</base-button
				>
				<base-button
					...
					>Printed</base-button
				>
				<base-button :class="setActiveLink('Audio')" @click="category = 'Audio'"
					>Audio</base-button
				>
				<base-button
			...
			<product-card
				...
				@set-format="category = product.format"></product-card>
		</div>
	</section>
</template>
