<template>
	<the-header title="Page Error">
		<template v-slot:text>
			<p class="text-center">
				The page you are looking for doesn't exist. Please try searching for some other
				page, <br />or return to the website's homepage to find what you're looking for.
			</p>
		</template>
	</the-header>
	<section
		...
		<h3 class="color-blue font-cardo text-center my-4">Page Not Found!</h3>
		<p class="text-center">
...
<script lang="ts">
import notFoundImg from "../assets/404-images/404.svg";
...
<style scoped>
section {
	background-image: url("../assets/404-images/404-bg.jpg");
